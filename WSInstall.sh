...
#apt install -y gnome-shell-extensions lm-sensors gnome-shell-extension-dash-to-panel gnome-shell-extension-top-icons-plus gnome-shell-extension-bluetooth-quick-connect gnome-shell-extension-desktop-icons-ng gnome-shell-extension-tiling-assistant
