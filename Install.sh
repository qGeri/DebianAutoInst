...
apt install dbus-user-session light-locker 
apt install thunar thunar-archive-plugin thunar-font-manager thunar-media-tags-plugin thunar-volman xfce4-goodies xfce4-terminal
